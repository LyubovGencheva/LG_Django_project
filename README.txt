...
### /login/                             Login (being redirected after register or NavBar-top-right when registered, but not logged in)
...
### /profile/                           User's profile page with options for profile info (username, e-mail, about, profile pic) updates
### /post/new/                          Create new post
                                            At an attempt by unauthenticated user: redirect to Login page
